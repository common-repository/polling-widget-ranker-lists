...
*The Ranker Widget, and this Plugin, will reach it's End of Life (EOD) on December 31st 2018. Please discontinue usage of the plugin at or before that time. Continued usage after the EOD date will not break your pages but, widgets will not load and your content display may be affected. We apologize for any inconvenience this causes.*
...
4. Example of customized Ranker widget in post loaded via shortcode.


== Changelog ==

= 3.0.4 =
- Updates option and shortcode pages width EOD messaging.
- Updates readme.txt details with EOD messaging.

= 3.0.3 =
- Updates the plugin to remove support for Slideshow widgets. All existing Slideshow widgets will now be displayed in Blog format.
- Removed Slideshow example assets.

= 3.0.2 =
- Updates the plugin to support our new 'blog' style widgets when creating shortcodes.
- If you have any older plugins running as slideshow you now want in blog format please create a new shortcode.
...
= 3.0.4 =
Updates option, shortcode and readme files with EOD messaging. High priority patch, recommended for all users.

= 3.0.3 =
Removes options related to slideshow format widgets. Low priority patch, but recommended.

= 3.0.2 =
Blog style lists are now fully supported in the plugin/widget. Recommended for all users.

= 3.0.1 =
Fixes issue with font face selection options. Low priority patch, but recommended.
