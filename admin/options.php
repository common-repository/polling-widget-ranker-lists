...
<form action="<?php echo htmlentities( $_SERVER[ 'PHP_SELF' ] ); ?>?page=<?php echo $_GET[ 'page' ]; ?>" method="post">
    ...
    <p class="eod-message">
        <?php esc_html_e( "The Ranker Widget, and this Plugin, will reach it's End of Life (EOD) on December 31st 2018. Please discontinue usage of the plugin at or before that time.", 'rnkrwp' ); ?><br/>
        <?php esc_html_e( "Continued usage after the EOD date will not break your pages but, widgets will not load and your content display may be affected.", 'rnkrwp' ); ?><br/>
        <?php esc_html_e( "We apologize for any inconvenience this causes.", 'rnkrwp' ); ?><br/>
    </p>
...
function rnkrwp_update_options(){
	...
	if( is_admin() && current_user_can( 'manage_options' ) ){
		...
		$list_slidebgcolor			= $current[ 'list_slidebgcolor' ];
